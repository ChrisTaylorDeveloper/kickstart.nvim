...
require('lazy').setup({
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = { html = true, axaml = true, xml = true, cs = true, js = true, dockerfile = true, php = true, c = true, cpp = true }
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'razor', 'c_sharp', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'sql', 'vim', 'vimdoc' },
